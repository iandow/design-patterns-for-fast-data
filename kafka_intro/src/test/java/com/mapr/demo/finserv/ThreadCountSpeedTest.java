...
public class ThreadCountSpeedTest {
    ...
    public static void openDataFile() throws FileNotFoundException {
        ...
        data.printf("acks, threadCount, topicCount, i, t, rate, dt, batchRate\n");
    }
    ...
    @Parameterized.Parameters(name = "{index}: acks={0}, threads={1}, topics={2}")
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"0", 1, 50}, {"0", 2, 50}, {"0", 5, 50}, {"0", 10, 50}, {"0", 15, 50}, {"0", 20, 50},
                {"0", 1, 100}, {"0", 2, 100}, {"0", 5, 100}, {"0", 10, 100}, {"0", 15, 100}, {"0", 20, 100},
                {"all", 1, 50}, {"all", 2, 50}, {"all", 5, 50}, {"all", 10, 50}, {"all", 15, 50}, {"all", 20, 50},
                {"all", 1, 100}, {"all", 2, 100}, {"all", 5, 100}, {"all", 10, 100}, {"all", 15, 100}, {"all", 20, 100},
        });
...
//        });
    ...
    private String acks = "0";  // default to async sends

    private static final ProducerRecord<String, byte[]> end = new ProducerRecord<>("end", null);

    public ThreadCountSpeedTest(String acks, int threadCount, int topicCount) {
